...
==== Spanish & Arabic (CBDI Only) at Base during Business Hours [[service-tasks]]
...
[discrete]
==== All Other Languages, Times, or Locations
Language Access Services automatically schedules in-person interpreters for Ambulatory and Periop encounters whenever possible, prioritizing in the following order:
...
4. End of life
5. Forensic interviews (e.g. Mayerson Center)
6. Mental health group settings (e.g. College Hill)
7. Care conferences
8. Rounds
9. Aquatic therapy
10. Shifts where interpreters are deployed on-demand (e.g. Emergency Department and <<service-tasks,Spanish & Arabic (CBDI Only) at Base during Business Hours>>)
11. Encounters with complex medical terminology
12. All other needs
