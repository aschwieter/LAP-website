...
1. Use a language identification card (shown below) or the list of languages on the <<video,Alvin>>.
+
image::{imagesdir}/language-poster.jpg[Language Identification Card,180,180]]

2. Call the xref:verbal.adoc#phone[phone interpreter line] and ask the operator to assist you in identifying the language.
